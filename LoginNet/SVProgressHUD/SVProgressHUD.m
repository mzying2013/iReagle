...
+(void)showWithCustomView:(UIView*)view maskType:(SVProgressHUDMaskType)maskType{
    [[SVProgressHUD sharedView] showWithCustomView:view maskType:maskType];
}
...
- (void)showWithCustomView:(UIView*)view maskType:(SVProgressHUDMaskType)hudMaskType{
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        NSLog(@"width:%f height:%f",CGRectGetWidth(view.frame),CGRectGetHeight(view.frame));
        self.hudView.bounds = CGRectMake(0, 0, CGRectGetWidth(view.frame), CGRectGetHeight(view.frame));
        [self.hudView setBackgroundColor:[UIColor clearColor]];
        [self.hudView setClipsToBounds:YES];
